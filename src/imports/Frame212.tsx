...
import imgInstagramPhones from "figma:asset/49d30e90e6000758c8382fe04dcd942e7b6139d9.png";
...
function Group3() {
  return (
    <div className="flex flex-col gap-[96px] relative shrink-0">
      <Group />
...
export default function Frame212() {
  return (
